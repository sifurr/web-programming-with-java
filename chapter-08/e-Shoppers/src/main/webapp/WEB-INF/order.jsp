                ...
                <div class="col-md-8 order-md-1">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="address"
                               name="address" placeholder="1234 Main Street"
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="address2"
                               name="address2"
                               value="${shippingAddress.address2}" placeholder="Apartment or Suite"/>
                    </div>
                    <div class="row">
                        <div class="col-md-5 mb-3">
                            ...
                            >
                                ...
                                <c:forEach var="country" items="${countries}">
                                    <option value="${countries}" ${country == shippingAddress.country ? 'selected="selected"' : ''}>
                                        ${country}
                                    </option>
                                </c:forEach>
                            </select>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="mobileNumber"
                                   name="mobileNumber" placeholder="+8801xxxxxxxxx"
